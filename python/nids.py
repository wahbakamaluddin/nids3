...
# sniff(iface='en0', prn=packet_capturer) # prn is the fallback function for each captured packets
sniff(iface='en0', prn=lambda x: x.summary()) # prn is the fallback function for each captured packets
